...
export default function ArticlesById() {
  ...
  return (
    ...
    <div className="single-article-container">
      ...
      <p className="single-article-author">By <span className="single-article-author-name">{articleById.author}</span></p>
      ...
      <p className="single-article-comment-count">Comment Count: {articleById.comment_count}</p>
      </div>
